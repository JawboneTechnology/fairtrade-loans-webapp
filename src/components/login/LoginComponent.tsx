...
const LoginComponent = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-brand/5 via-white to-light/20 flex flex-col">
      {/* Header Section with Logo */}
      <div className="bg-gradient-to-r from-brand to-brand/90 pt-12 pb-8 px-6 rounded-b-3xl md:rounded-b-md shadow-lg">
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 -mt-4 relative z-10">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="text-center p-3 bg-brand/5 rounded-xl">
                <div className="text-brand font-bold text-lg">Fast</div>
              ...
              {!showOtpCodeInput && (
                <div>
                  ...
                  <FloatingInput
                    ...
                    className="mb-1 [&>input]:px-5 [&>input]:py-4 [&>input]:text-base [&>input]:rounded-xl [&>input]:border-2 [&>input]:border-gray-200 [&>input]:focus:border-brand [&>input]:bg-gray-50 [&>input]:focus:bg-white w-full"
                ...
                <>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        <div className="bg-brand/10 rounded-full p-2">
                          <RiLock2Fill className="text-brand text-sm" />
                        </div>
                        <div>
                  ...
                  <div className="text-center mb-5">
                    <Link
                      ...
                      className="inline-flex items-center text-sm font-medium text-brand hover:text-brand/80 bg-brand/5 px-4 py-2 rounded-full"
                    >
                  ...
                  {/* brand Action Button */}
                  <UniversalButton
                    className="bg-gradient-to-r from-brand to-brand/90 hover:from-brand/90 hover:to-brand w-full text-white rounded-2xl py-4 text-lg font-semibold shadow-lg shadow-brand/25 hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200"
          ...
          <div className="mt-8 text-center">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
              ...
              <Link
                to="/auth-register"
                className="inline-flex items-center justify-center w-full bg-white text-brand border border-brand font-semibold py-4 px-6 rounded-2xl transform hover:scale-[1.02] transition-all duration-200"
              >
      ...
      <div className="bg-gray-50 py-4 px-6">
        <div className="text-center">
          <p className="text-xs text-dark/50">
            © 2025 JSTL Foundation • Empowering Communities
          </p>
        </div>
      </div>
    </div>
